                            ...
                            <div class="v-col-padding" style="box-sizing: border-box; height: 100%; padding: 15px 20px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                ...
                                <tbody>
                                    ...
                                    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Lato',sans-serif;" align="left">
                                        ...
                                        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><strong>Confirmamos a submissão do formulário para escolas!</strong></span></p>
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Lato',sans-serif;" align="left">
                                        ...
                                        <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                        <p style="line-height: 140%; font-size: 14px;"><span style="font-size: 18px; line-height: 25.2px;">${body}</span></p>
                                        </div>
                                    ...
                                    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px;font-family:'Lato',sans-serif;" align="left">
                                        ...
                                        <tbody><tr>
                                            ...
                                            <a href="https://www.whatsapp.com/channel/0029Va9z9d2JP2184daqbX0K" target="_blank">
                                                <img align="center" border="0" src="https://storage.carrismetropolitana.pt/static/assets/email/cm-email-footer-whatsapp.png" alt="WhatsApp da Carris Metropolitana" title="WhatsApp da Carris Metropolitana" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 125px;" width="125">
                                            </a>
                                            </td>
                                        </tr>
                                        </tbody></table>
                                    ...
                                    <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px;font-family:'Lato',sans-serif;" align="left">
                                        ...
                                        <tbody><tr>
                                            ...
                                            <a href="https://twitter.com/CMetropolitana_" target="_blank">
                                                <img align="center" border="0" src="https://storage.carrismetropolitana.pt/static/assets/email/cm-email-footer-twitter.png" alt="Twitter da Carris Metropolitana" title="LinkedIn da Carris Metropolitana" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 125px;" width="125">
                                            </a>
                                            </td>
                                        </tr>
                                        </tbody></table>
